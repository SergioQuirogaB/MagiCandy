    ...
    <!-- MENU DE INVENTARIO CON SUB CATEGORIAS -->
        <div class="iocn-link">
            ...
            <ul class="sub-menu">
                ...
                <li><a href="../DAHSPAGS/RegistraProducto.php">- Registra Productos</a></li>
                <li><a href="../DAHSPAGS/EntradaProducto.php">- Entrada Productos</a></li>
...
<div class="parent">
<div class="div1"> 
<a href="../DAHSPAGS/CrearOrden.php">
            <button class="back">
...
<div class="div2">
    <a href="../CRUD/descargarExcel.php">
    ...
    <?php
        ...
        <tr style="text-align: center; font-size: 16px">
            ...
            <td style="text-align: center;">
                ...
                <button class="btn-delete" style="width: 40%"><a href="../CRUD/eliminarOrden.php?id=<?= $datos->pkid_produccion ?>"><i class="fas fa-trash-alt" style="color: white;"></i></a></button><br>
            </td>
        </tr>
    <?php } ?>
